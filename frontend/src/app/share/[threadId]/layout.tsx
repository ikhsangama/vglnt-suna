...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Sandbay AI',
    description: 'Replay this Agent conversation on Sandbay AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Sandbay AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Sandbay AI';
